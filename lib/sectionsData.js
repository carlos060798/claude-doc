...
export const SECTION_CONTENT = {
  'dashboard': { title: 'Dashboard', lead: 'Centro de control de Claude Code Mastery Guide.' },
  'curso': { title: 'Curso Interactivo', lead: 'Aprendizaje estructurado en 7 módulos.' },
  'desafios': { title: 'Desafíos', lead: 'Retos interactivos para poner en práctica lo aprendido.' },
  ...
  'nivel-1': { title: 'Nivel 1 — Fundamentos', lead: 'Los comandos esenciales para comenzar.' },
  'nivel-2': { title: 'Nivel 2 — Avanzado (MCP)', lead: 'Gestión de contexto y Model Context Protocol.' },
  'nivel-3': { title: 'Nivel 3 — Experto (Skills)', lead: 'Crea Skills personalizadas y agentes.' },
  'agente-sdk': { title: 'Agent SDK', lead: 'Construcción programática de agentes autónomos.' },
  'api-anthropic': { title: 'Anthropic API', lead: 'La API de mensajes con streaming, vision y batch.' },
