...
,
  'primeros-pasos': {
    title: "Primeros Pasos",
    breadcrumb: "Secciones / Primeros Pasos",
    lead: "Tus primeros comandos con Claude Code",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
        title: "Sección en construcción",
        text: "Esta sección está siendo completada. Por ahora, consulta la documentación oficial en https://docs.anthropic.com"
      },
      {
        type: "paragraph",
        text: "Contenido completo próximamente."
      }
    ]
  },
  'claude-md': {
    title: "CLAUDE.md",
    breadcrumb: "Secciones / CLAUDE.md",
    lead: "La configuración persistente de tus proyectos",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'flujos-dev': {
    title: "Flujos Dev Reales",
    breadcrumb: "Secciones / Flujos Dev Reales",
    lead: "Workflows diarios del desarrollador",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'nivel-1': {
    title: "Nivel 1 — Fundamentos",
    breadcrumb: "Secciones / Nivel 1 — Fundamentos",
    lead: "Los comandos esenciales para comenzar",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'nivel-2': {
    title: "Nivel 2 — Avanzado (MCP)",
    breadcrumb: "Secciones / Nivel 2 — Avanzado (MCP)",
    lead: "Gestión de contexto y Model Context Protocol",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'nivel-3': {
    title: "Nivel 3 — Experto (Skills)",
    breadcrumb: "Secciones / Nivel 3 — Experto (Skills)",
    lead: "Crea Skills personalizadas y agentes",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'nivel-4': {
    title: "Nivel 4 — Maestría Práctica",
    breadcrumb: "Secciones / Nivel 4 — Maestría Práctica",
    lead: "Domina Claude Code en casos reales",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'git-workflows': {
    title: "Git Workflows Reales",
    breadcrumb: "Secciones / Git Workflows Reales",
    lead: "Workflows avanzados con Git",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'mcp-use-cases': {
    title: "MCPs por Caso de Uso",
    breadcrumb: "Secciones / MCPs por Caso de Uso",
    lead: "MCPs especializados para cada tarea",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'hooks-production': {
    title: "Hooks en Producción",
    breadcrumb: "Secciones / Hooks en Producción",
    lead: "Automatización con hooks de producción",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'multi-mcp-orchestration': {
    title: "Multi-MCP Orchestration",
    breadcrumb: "Secciones / Multi-MCP Orchestration",
    lead: "Orquestación de múltiples MCPs",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'agente-sdk': {
    title: "Agent SDK",
    breadcrumb: "Secciones / Agent SDK",
    lead: "Construcción programática de agentes autónomos",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'api-anthropic': {
    title: "Anthropic API",
    breadcrumb: "Secciones / Anthropic API",
    lead: "La API de mensajes con streaming, vision y batch",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'skills-avanzados': {
    title: "Skills Avanzados",
    breadcrumb: "Secciones / Skills Avanzados",
    lead: "Crea Skills personalizadas complejas",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'ci-cd': {
    title: "CI/CD & Headless",
    breadcrumb: "Secciones / CI/CD & Headless",
    lead: "Integración en pipelines de CI/CD",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'intro-acc': {
    title: "¿Qué es Claude Code?",
    breadcrumb: "Secciones / ¿Qué es Claude Code?",
    lead: "Una introducción amable para todos",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'casos-rol': {
    title: "Casos por Rol",
    breadcrumb: "Secciones / Casos por Rol",
    lead: "Claude Code para tu rol específico",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'casos-uso': {
    title: "Casos de Uso",
    breadcrumb: "Secciones / Casos de Uso",
    lead: "Cómo usar Claude Code en la práctica",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
  ...
  'mejores-practicas': {
    title: "Mejores Prácticas",
    breadcrumb: "Secciones / Mejores Prácticas",
    lead: "Patrones ganadores en producción",
    content: [
      {
        type: "info-banner",
        icon: "🔧",
