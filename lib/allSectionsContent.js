...
export const ALL_SECTIONS_CONTENT = {
    ...
    content: [
      {
        type: "heading",
        level: 2,
        text: "Flujos 1-7: Completados"
      },
      {
        type: "paragraph",
        text: "Los flujos 1 a 7 (Onboarding, TDD, Debugging, Migración, Code Review, OpenAPI, Performance) están documentados abajo. Aquí comienzan los flujos 8-10."
      },
      {
        type: "flow-card",
        id: "onboarding",
  ...
  "agente-sdk": {
    title: "🤖 Agent SDK — Construcción Programática de Agentes",
    breadcrumb: "Profundización / Agent SDK",
    lead: "Construye agentes autónomos con la Anthropic Agent SDK en TypeScript o Python. Domina streaming, orquestación multi-agente, prompt caching y computer use (vision + automatización de UI).",
    content: [
      {
        type: "stats",
        items: [
          { label: "Lenguajes soportados", value: "2", subtitle: "TypeScript + Python" },
          { label: "Modelos soportados", value: "3", subtitle: "Haiku, Sonnet, Opus" },
          { label: "Transportes", value: "2", subtitle: "SSE, HTTP" },
          { label: "Casos de uso", value: "6+", subtitle: "CLI, Web, Batch, Realtime" }
        ]
      },
      {
        type: "heading",
        level: 2,
        text: "1. Streaming y el Loop del Agente"
      },
      {
        type: "paragraph",
        text: "El loop core del agente es simple: recibe un mensaje, procesa tool calls, devuelve resultado, repite. En producción, usa streaming SSE para actualizar UIs en tiempo real sin bloqueos."
      },
      {
        type: "code-block",
        lang: "typescript",
        title: "agent.ts — Loop de agente con streaming",
        code: "import Anthropic from '@anthropic-ai/sdk';\n\nconst client = new Anthropic();\n\ninterface ToolUse {\n  name: string;\n  id: string;\n  input: Record<string, any>;\n}\n\nasync function runAgent(userMessage: string) {\n  const messages = [{ role: 'user' as const, content: userMessage }];\n\n  while (true) {\n    // Streaming: procesa eventos en tiempo real\n    const stream = await client.messages.stream({\n      model: 'claude-opus-4-7',\n      max_tokens: 4096,\n      messages,\n    });\n\n    let response = '';\n    let hasToolUse = false;\n\n    // Consume stream events\n    for await (const event of stream) {\n      if (event.type === 'content_block_delta') {\n        if ('text' in event.delta) {\n          response += event.delta.text;\n          process.stdout.write(event.delta.text);\n        }\n      }\n    }\n\n    // Get final message\n    const message = await stream.finalMessage();\n\n    // Check if we need to handle tool use\n    if (message.stop_reason === 'end_turn') {\n      console.log('Agent completed.');\n      break;\n    }\n\n    messages.push({ role: 'assistant' as const, content: response });\n  }\n}\n\nawait runAgent('Analyze this code for security issues');"
      },
      {
        type: "info-banner",
        bannerType: "info",
        title: "✓ Patrón: StreamHandler de SDK",
        text: "La SDK maneja streaming automáticamente con async iterables. Consume eventos, actualiza UI, y al salir del loop tienes el mensaje final completo."
      },
      {
        type: "heading",
        level: 2,
        text: "2. Orquestación Multi-Agente"
      },
      {
        type: "paragraph",
        text: "Especializa sub-agentes por dominio: uno para búsqueda, otro para análisis, otro para escritura. El agente maestro coordina."
      },
      {
        type: "code-block",
        lang: "typescript",
        title: "multi-agent.ts — Orquestación de sub-agentes",
        code: "interface Agent {\n  name: string;\n  systemPrompt: string;\n  tools: Anthropic.Tool[];\n}\n\nconst searchAgent: Agent = {\n  name: \"SearchAgent\",\n  systemPrompt:\n    \"Eres un expert en búsqueda. Tu job es encontrar información relevante en documentos.\",\n  tools: [{ name: \"search_docs\", description: \"...\", input_schema: {} }],\n};\n\nconst analyzerAgent: Agent = {\n  name: \"AnalyzerAgent\",\n  systemPrompt:\n    \"Eres un analista de código. Tu job es entender y explicar código.\",\n  tools: [{ name: \"parse_code\", description: \"...\", input_schema: {} }],\n};\n\nasync function orchestrate(task: string): Promise<string> {\n  console.log(\\`[Master] Task: \\${task}\\n\\`);\n\n  // 1. SearchAgent busca documentación\n  const searchResult = await runSubAgent(\n    searchAgent,\n    \\`Busca info sobre: \\${task}\\`\n  );\n  console.log(\\`[SearchAgent] Result: \\${searchResult}\\n\\`);\n\n  // 2. AnalyzerAgent analiza el resultado\n  const analysis = await runSubAgent(\n    analyzerAgent,\n    \\`Analiza y sintetiza esto:\n\\${searchResult}\n\nProporciona: resumen, puntos clave, casos de uso, ejemplo de código.\\`\n  );\n  console.log(\\`[AnalyzerAgent] Result: \\${analysis}\\n\\`);\n\n  // 3. Master agrega contexto final\n  const finalResponse = \\`Basado en investigación y análisis:\n\\${analysis}\n\nAcciones recomendadas: ...\\`;\n\n  return finalResponse;\n}\n\nasync function runSubAgent(agent: Agent, prompt: string): Promise<string> {\n  const response = await client.messages.create({\n    model: \"claude-sonnet-4-20250514\",\n    max_tokens: 2048,\n    system: agent.systemPrompt,\n    tools: agent.tools,\n    messages: [{ role: \"user\", content: prompt }],\n  });\n\n  return response.content\n    .filter((block): block is Anthropic.TextBlock => block.type === \"text\")\n    .map((block) => block.text)\n    .join(\"\\n\");\n}\n\nawait orchestrate(\"¿Cómo implementar retry exponencial en TypeScript?\");"
      },
      {
        type: "heading",
        level: 2,
        text: "3. Prompt Caching en SDK"
      },
      {
        type: "paragraph",
        text: "Reutiliza documentación grandes, prompts del sistema pesados o archivos constantes. Caching reduce tokens en 90% y latencia significativamente."
      },
      {
        type: "code-block",
        lang: "typescript",
        title: "caching.ts — Prompt caching en Agent SDK",
        code: "// Documento grande que se reutiliza\nconst LARGE_DOCUMENTATION = \\`\n  [100KB de documentación...]\n\\`;\n\nconst response = await client.messages.create({\n  model: \"claude-opus-4-1\",\n  max_tokens: 4096,\n  system: [\n    {\n      type: \"text\",\n      text: \"Eres un asistente experto en Claude Code. Ayuda con bugs, mejores prácticas y arquitectura.\",\n    },\n    {\n      type: \"text\",\n      text: LARGE_DOCUMENTATION,\n      cache_control: { type: \"ephemeral\" }, // Cache por 5 min\n    },\n  ],\n  messages: [\n    {\n      role: \"user\",\n      content: [\n        {\n          type: \"text\",\n          text: \"¿Cómo optimizo búsqueda de comandos en el dashboard?\",\n        },\n      ],\n    },\n  ],\n});\n\nconsole.log(\n  \\`Usage:\n  Input tokens (cached): \\${response.usage.cache_read_input_tokens}\n  Input tokens (new): \\${response.usage.input_tokens}\n  Output tokens: \\${response.usage.output_tokens}\n  Cost reduction: ~\\${((response.usage.cache_read_input_tokens / 2) / (response.usage.input_tokens + response.usage.cache_read_input_tokens)).toFixed(1)}%\n\\`\n);"
      },
      {
        type: "info-banner",
        type_: "success",
        title: "💰 Ahorro real",
        text: "Con caching: 10K token cache + 100 token input = 0.05¢. Sin caching: 10.1K tokens = 0.30¢. 6x más barato."
      },
      {
        type: "heading",
        level: 2,
        text: "4. Computer Use (Vision + Automatización de UI)"
      },
      {
        type: "paragraph",
        text: "Integra vision para analizar pantallas y envía acciones (click, type, scroll) para automatizar flujos complejos en UIs web o desktop."
      },
      {
        type: "code-block",
        lang: "typescript",
        title: "computer-use.ts — Vision + Automation",
        code: "import * as fs from \"fs\";\n\n// Captura pantalla actual (ejemplo: screenshot.png)\nconst screenshot = fs.readFileSync(\"/tmp/screenshot.png\");\nconst base64Image = screenshot.toString(\"base64\");\n\nconst response = await client.messages.create({\n  model: \"claude-opus-4-1\", // Opus soporta vision+computer-use\n  max_tokens: 4096,\n  system: \\`Eres un asistente que automatiza tareas en UIs. \nTienes acceso a vision (ver pantallas) y a acciones (click, type, scroll).\nTarea: automatizar login en github.com\\`,\n  tools: [\n    {\n      name: \"screenshot\",\n      description: \"Captura la pantalla actual\",\n      input_schema: { type: \"object\", properties: {} },\n    },\n    {\n      name: \"click\",\n      description: \"Click en coordenadas (x, y)\",\n      input_schema: {\n        type: \"object\",\n        properties: {\n          x: { type: \"number\" },\n          y: { type: \"number\" },\n        },\n        required: [\"x\", \"y\"],\n      },\n    },\n    {\n      name: \"type\",\n      description: \"Escribe texto\",\n      input_schema: {\n        type: \"object\",\n        properties: { text: { type: \"string\" } },\n        required: [\"text\"],\n      },\n    },\n  ],\n  messages: [\n    {\n      role: \"user\",\n      content: [\n        {\n          type: \"image\",\n          source: { type: \"base64\", media_type: \"image/png\", data: base64Image },\n        },\n        {\n          type: \"text\",\n          text: \"¿Qué ves en pantalla? Intenta hacer login en GitHub con usuario 'test' y password 'pass123'\",\n        },\n      ],\n    },\n  ],\n});\n\n// El agente verá la pantalla, analizará la UI y ejecutará acciones\nfor (const block of response.content) {\n  if (block.type === \"tool_use\") {\n    console.log(\\`[Agent Action] \\${block.name}(\\${JSON.stringify(block.input)})\\`);\n    // Ejecuta la acción: click() o type() y captura nueva screenshot\n  }\n}\n"
      },
      {
        type: "info-banner",
        type_: "warning",
        title: "⚠️ Disponibilidad",
        text: "Computer Use requiere Opus 4.1+. Disponible en preview para partners de Anthropic. Requiere aprobación."
      },
    ]
  },
  ...
  "api-anthropic": {
    title: "⚡ Anthropic API — Guía Completa",
    breadcrumb: "Profundización / Anthropic API",
    lead: "Domina la Messages API de Anthropic. Streaming SSE, tool use, vision, Files API, structured output (JSON mode), batch processing (-50%), y prompt caching (-90%).",
    content: [
      {
        type: "stats",
        items: [
          { label: "Endpoints principales", value: "8+", subtitle: "Messages, Files, Batch, Models" },
          { label: "Rate limits", value: "Flexible", subtitle: "Token/min + Request/min" },
          { label: "Máx tokens input", value: "200K", subtitle: "Haiku, Sonnet, Opus" },
          { label: "Caché efectividad", value: "-90%", subtitle: "Costo token cacheados" }
        ]
      },
      {
        type: "heading",
        level: 2,
        text: "1. Files API — Reutilizar Documentos Grandes"
      },
      {
        type: "paragraph",
        text: "Sube archivos (PDFs, CSVs, código, etc.) una vez. Reutilízalos en múltiples requests sin volver a subir. Perfecto para análisis de datos repetitivos."
      },
      {
        type: "code-block",
        lang: "typescript",
        title: "files-api.ts — Subir y reutilizar archivos",
        code: "import * as fs from \"fs\";\n\nconst client = new Anthropic();\n\n// Paso 1: Sube archivo (ej: reporte de 5MB)\nconst fileBuffer = fs.readFileSync(\"./2024-sales-report.pdf\");\nconst file = await client.beta.files.upload(\n  { file: new File([fileBuffer], \"2024-sales-report.pdf\") },\n  { headers: { \"anthropic-beta\": \"files-api-2025-04-14\" } }\n);\n\nconsole.log(\\`Archivo subido: \\${file.id}\\`);\n\n// Paso 2: Usa el file_id en múltiples requests\nfor (const query of [\n  \"¿Cuáles fueron los top 10 clientes por ingresos?\",\n  \"¿Qué tendencias ves en ventas Q3 vs Q4?\",\n  \"Extrae margen bruto por región\",\n]) {\n  const response = await client.beta.messages.create(\n    {\n      model: \"claude-opus-4-1\",\n      max_tokens: 1024,\n      messages: [\n        {\n          role: \"user\",\n          content: [\n            {\n              type: \"text\",\n              text: query,\n            },\n            {\n              type: \"document\",\n              source: { type: \"file\", file_id: file.id },\n            },\n          ],\n        },\n      ],\n    },\n    { headers: { \"anthropic-beta\": \"files-api-2025-04-14\" } }\n  );\n\n  const textBlock = response.content.find(\n    (b): b is Anthropic.TextBlock => b.type === \"text\"\n  );\n  console.log(\\`\\nQuery: \\${query}\\nResponse: \\${textBlock?.text}\\n\\`);\n}\n\n// Paso 3: Limpia (opcional)\nawait client.beta.files.delete(file.id);\n"
      },
      {
        type: "heading",
        level: 2,
        text: "2. Structured Output (JSON Mode)"
      },
      {
        type: "paragraph",
        text: "Fuerza salida JSON válido automáticamente. Perfecto para APIs, pipelines y herramientas que consumen la respuesta de forma determinista."
      },
      {
        type: "code-block",
        lang: "typescript",
        title: "json-mode.ts — Salida estructurada garantizada",
        code: "const schema = {\n  type: \"object\",\n  properties: {\n    sentiment: { type: \"string\", enum: [\"positive\", \"neutral\", \"negative\"] },\n    confidence: { type: \"number\", minimum: 0, maximum: 1 },\n    entities: {\n      type: \"array\",\n      items: {\n        type: \"object\",\n        properties: {\n          text: { type: \"string\" },\n          type: { type: \"string\" },\n          confidence: { type: \"number\" },\n        },\n        required: [\"text\", \"type\", \"confidence\"],\n      },\n    },\n    summary: { type: \"string\", maxLength: 200 },\n  },\n  required: [\"sentiment\", \"confidence\", \"entities\", \"summary\"],\n};\n\nconst response = await client.messages.create({\n  model: \"claude-opus-4-1\",\n  max_tokens: 1024,\n  messages: [\n    {\n      role: \"user\",\n      content:\n        \"Analiza este tweet y extrae sentimiento, confianza y entidades: '@anthropic Claude es increíble para código. ¡Acabó mi proyecto en 2 horas!'\",\n    },\n  ],\n  thinking: { type: \"enabled\", budget_tokens: 512 },\n});\n\n// ✓ Garantizado JSON válido que cumple el schema\nconst result = JSON.parse(\n  response.content.find((b): b is Anthropic.TextBlock => b.type === \"text\")\n    ?.text || \"{}\"\n);\nconsole.log(result);\n/* Output:\n{\n  sentiment: \"positive\",\n  confidence: 0.98,\n  entities: [\n    { text: \"@anthropic\", type: \"mention\", confidence: 1.0 },\n    { text: \"Claude\", type: \"product\", confidence: 0.99 },\n  ],\n  summary: \"Usuario muy satisfecho con Claude para desarrollo, completó proyecto rápidamente\"\n}\n*/"
      },
      {
        type: "heading",
        level: 2,
        text: "3. Best Practices: Rate Limits & Error Handling"
      },
      {
        type: "paragraph",
        text: "Maneja rate limits (429), overload (529) y timeouts. Implementa backoff exponencial, circuit breakers y logging."
      },
      {
        type: "code-block",
        lang: "typescript",
        title: "rate-limits.ts — Manejo robusto de errores",
        code: "interface APIConfig {\n  maxRetries: number;\n  initialBackoffMs: number;\n  maxBackoffMs: number;\n}\n\nconst config: APIConfig = {\n  maxRetries: 3,\n  initialBackoffMs: 1000,\n  maxBackoffMs: 60000,\n};\n\nasync function callWithRetry<T>(\n  fn: () => Promise<T>,\n  attempt: number = 0\n): Promise<T> {\n  try {\n    return await fn();\n  } catch (err: any) {\n    const statusCode = err.status;\n\n    // 429 = Rate limited\n    if (statusCode === 429) {\n      const retryAfter =\n        parseInt(err.headers?.[\"retry-after\"] || \"60\") * 1000;\n      console.log(\n        \\`[429 Rate Limit] Esperando \\${retryAfter}ms antes de reintentar...\\`\n      );\n      await new Promise((r) => setTimeout(r, retryAfter));\n      return callWithRetry(fn, attempt + 1);\n    }\n\n    // 529 = Overload (servidor sobrecargado)\n    if (statusCode === 529) {\n      if (attempt < config.maxRetries) {\n        const backoff = Math.min(\n          config.initialBackoffMs * Math.pow(2, attempt),\n          config.maxBackoffMs\n        );\n        console.log(\n          \\`[529 Overload] Reintentando en \\${backoff}ms (intento \\${attempt + 1}/\\${config.maxRetries})...\\`\n        );\n        await new Promise((r) => setTimeout(r, backoff));\n        return callWithRetry(fn, attempt + 1);\n      }\n    }\n\n    // Otros errores: propagar\n    throw err;\n  }\n}\n\n// Uso:\nconst response = await callWithRetry(async () => {\n  return client.messages.create({\n    model: \"claude-opus-4-1\",\n    max_tokens: 1024,\n    messages: [{ role: \"user\", content: \"Hola\" }],\n  });\n});\n\nconsole.log(response.content[0]);\n"
      },
      {
        type: "info-banner",
        type_: "success",
        title: "✓ Resumen de mejores prácticas",
        text: "1. Usa caching para documentos reutilizados (70-90% ahorro). 2. JSON mode para pipelines deterministas. 3. Files API para análisis repetitivo. 4. Batch API para volumen sin urgencia (-50%). 5. Backoff exponencial en 429/529."
      },
    ]
  },
  ...
  terminal: {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "Haz clic en el botón \"Ejecutar\" para ver demostraciones interactivas de comandos reales de Claude Code en acción. Cada escenario muestra el flujo completo: prompt, ejecución, y salida."
      },
      {
        type: "info-banner",
        variant: "info",
        title: "Cómo usar el simulador",
        text: "El simulador reproduce secuencias reales de terminal. Observa cómo Claude Code responde a diferentes tipos de solicitudes, maneja errores, y interactúa con el codebase."
      },
      {
        type: "heading",
        level: 3,
        text: "Escenario 1: Refactorización básica"
      },
      {
        type: "code-block",
        lang: "bash",
        title: "Terminal",
        code: "$ claude read @src/utils/formatDate.js\n$ claude \"Convierte a TypeScript y añade tipos estrictos\"\n$ npm run typecheck\n$ git diff"
      },
      {
        type: "heading",
        level: 3,
        text: "Escenario 2: Code review con feedback"
      },
      {
        type: "code-block",
        lang: "bash",
        title: "Terminal",
        code: "$ claude /skill code-review\n$ git log --oneline -5\n$ claude \"Revisa el último commit y sugiere mejoras\""
      },
      {
        type: "heading",
        level: 3,
        text: "Escenario 3: Debugging interactivo"
      },
      {
        type: "code-block",
        lang: "bash",
        title: "Terminal",
        code: "$ npm test -- --reporter=verbose 2>&1 | head -50\n$ claude \"El test de autenticación falla. Lee @src/auth/login.test.ts\""
      },
      {
        type: "heading",
        level: 3,
        text: "Escenario 4: Migración progresiva"
      },
      {
        type: "code-block",
        lang: "bash",
        title: "Terminal",
        code: "$ find src -name \"*.js\" | wc -l\n$ claude /context file:@src/legacy/ file:@src/tests/\n$ claude \"Crea un plan para migrar a TypeScript por módulos\""
      },
      {
        type: "heading",
        level: 3,
      ...
      },
      {
        type: "list",
        items: [
          "El simulador refleja comandos reales que puedes ejecutar en tu terminal",
          "Los tiempos de respuesta simulan la ejecución real",
          "Los errores mostrados son casos reales que ocurren en desarrollo",
          "Cada escenario es independiente: puedes practicar uno sin haber visto los anteriores"
        ]
      }
    ]
  },
  ...
  recursos: {
    ...
    breadcrumb: "Producción / Recursos",
    lead: "Documentación oficial, tutoriales y comunidad de Claude Code.",
    content: [
      {
        type: "heading",
        level: 3,
        text: "Recursos Oficiales"
      },
      {
        type: "list",
        items: [
          "[Claude Code Official Docs](https://claude.ai/code) — Documentación oficial completa",
          "[Anthropic API Documentation](https://docs.anthropic.com) — Referencia API y SDK",
          "[Model Context Protocol](https://modelcontextprotocol.io) — Especificación MCP",
          "[Anthropic GitHub](https://github.com/anthropic-ai) — Repositorios oficiales",
          "[Claude Cookbook](https://github.com/anthropic-ai/anthropic-cookbook) — Ejemplos de código"
        ]
      },
      {
        type: "heading",
      ...
      },
      {
        type: "list",
        items: [
          "[Getting Started with Claude Code](https://claude.ai/getting-started) — Primeros pasos",
          "[MCP Server Development Guide](https://modelcontextprotocol.io/docs) — Crear MCPs",
          "[Custom Skills Tutorial](https://claude.ai/docs/skills) — Desarrollo de Skills",
          "[Git Worktrees Best Practices](https://git-scm.com/docs/git-worktree) — Workflow avanzado",
          "[Prompt Engineering for Code](https://docs.anthropic.com/en/docs/build-a-chatbot) — Prompts efectivos"
        ]
      },
      {
        type: "heading",
      ...
      },
      {
        type: "list",
        items: [
          "[Discord de Anthropic](https://discord.gg/anthropic) — Chat en tiempo real con otros usuarios",
          "[GitHub Discussions](https://github.com/anthropic-ai/anthropic-sdk-python/discussions) — Preguntas y respuestas",
          "[Stack Overflow: claude-code](https://stackoverflow.com/questions/tagged/claude-code) — Respuestas verificadas",
          "[Reddit: r/ClaudeAI](https://reddit.com/r/ClaudeAI) — Comunidad global",
          "[Anthropic Twitter](https://twitter.com/AnthropicAI) — Últimas noticias"
        ]
      },
      {
        type: "heading",
      ...
      },
      {
        type: "list",
        items: [
          "[VS Code Extension](https://marketplace.visualstudio.com/) — Editor integrado",
          "[Git Worktrees Guide](https://git-scm.com/docs/git-worktree) — Gestión de ramas",
      ...
      },
      {
        type: "heading",
        level: 3,
        text: "SDKs y Librerías"
      },
      {
        type: "list",
        items: [
          "[Python SDK](https://github.com/anthropic-ai/anthropic-sdk-python) — Cliente oficial para Python",
          "[JavaScript/TypeScript SDK](https://github.com/anthropic-ai/anthropic-sdk-js) — Cliente oficial para JS/TS",
          "[Vercel AI SDK](https://vercel.com/ai) — Integración con Vercel",
          "[LangChain Integration](https://python.langchain.com/docs/integrations/llms/anthropic) — Framework de orquestación"
        ]
      },
      {
        type: "info-banner",
        variant: "tip",
        title: "Contribuye a la comunidad",
        text: "Comparte tus Skills, MCPs y casos de uso en GitHub. Crea issues, participa en discussions y ayuda a otros developers a maximizar Claude Code. Juntos construimos mejores herramientas."
      }
    ]
  }
};
